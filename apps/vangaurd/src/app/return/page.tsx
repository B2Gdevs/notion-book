...
import { Button, useGetOrg, useUpdateOrg } from 'ui';
...
const ReturnPage: React.FC = () => {
	...
	}, [org, orgLoading, accountId, updateOrgMutation]);
	...
	return (
		<div className='flex flex-col items-center p-8 max-w-2xl mx-auto space-y-6'>
			<h1 className='text-4xl '>
				We are getting ready to start delivering your orders!
			</h1>
			<div className='text-lg mt-4 text-center'>
				You will be redirected within 2 seconds to the organizations page. If
				not, please click the button below.
			</div>
			...
			<Button onClick={() => router.push('/')}>Go to Organizations</Button>
		</div>
	);
};
